...
<form method="post" action="updateUserMsg" class="registerForm">
    <div class="registerDiv" style="margin: 145px 20px">
        ...
        <table class="registerTable" align="center">
            <tr>
                <td  class="registerTip registerTableLeftTD" style="color: red">修改账号信息，请谨慎修改</td>
                <td></td>
            </tr>
            <tr>
                <td  class="registerTableRightTD"><input id="name" name="name" value="${user.name}" style="display: none"> </td>
            </tr>
            <tr>
