		...
		<div>
			...
			<table class="addressTable">
				<tr>
					...
					<td><textarea name="address" placeholder="建议您如实填写详细收货地址，例如接到名称，门牌好吗，楼层和房间号等信息">广州商学院一栋6楼收</textarea></td>
				</tr>
				<tr>
					<td>邮政编码</td>
					<td><input  name="post" placeholder="如果您不清楚邮递区号，请填写000000" type="text" value="000000"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input name="mobile"  placeholder="请输入11位手机号码" type="text" value="xxxxxxxxxxxxxxx"></td>
				</tr>
			</table>
			...
			<thead>
				<tr>
					<th colspan="2" class="productListTableFirstColumn">
						...
						<a class="marketLink" href="#nowhere">店铺：广商GO</a>
