	...
	<form class="loginForm" action="forelogin" method="post">
		<div id="loginSmallDiv" class="loginSmallDiv">
			...
			<span class="loginInputIcon ">
				...
				<input id="kaptcha" name="kaptcha" type="text" placeholder="验证码">
			</div>
			<img src="./kaptcha/getKaptchaImage.do" id="kaptchaImage"  style="margin-bottom: -5px"/>
			<a href="#" onclick="changeCode()" style="margin-left: 10px"/>看不清？换一张</a>
